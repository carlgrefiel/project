...
<section class="authors">
   ...
   <div class="box">
      ...
      <a href="author_posts.php?author=<?= $fetch_authors['firstname']; ?>" class="btn">view posts</a>
   </div>
   <?php
      }
   }else{
