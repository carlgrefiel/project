...
?>
   ...
   <form action="" method="POST">
      ...
      <div class="inline-delete-btn" onclick="window.location.href = 'view_post.php?post_id=<?= $get_id; ?>';">cancel edit</div>
   </form>
   </section>
<?php
   }
...
<section class="comments-container">
   ...
   <form action="" method="post" class="add-comment">
      <input type="hidden" name="author_id" value="<?= $fetch_admin_id['author_id']; ?>">
      <input type="hidden" name="user_name" value="<?= $fetch_profile['firstname']; ?>">
      <p class="user"><i class="fas fa-user"></i><a href="update.php"><?= $fetch_profile['firstname']; ?></a></p>
